...
/*
        ...
        found += sscanf (buffer, "MemAvailable:\t%" SCNu64 " kB", &memory_available);
  ...
  //  memory_available*=1024;
   ...
   // __uint64_t memory_used= memory_total-memory_available;
   // printf("its all in the memory %llu\n",memory_usage.memory_used);
   __uint64_t  swap_used = swap_total-swap_free;
  ...
  //  memory_usage->memory_percentage = percentage;
