...
*/
 ...
 //Parse the stat file
       ...
       // unsigned  long long stime;
        ...
        sscanf(buffer, "%i %255s %1s %i %i %i %i %i %255s %255s %255s %255s %255s %lu %lu %i %i %i %hi %i %i %ld %ld %ld %255s %255s %255s %i %255s %255s %255s %255s %255s %255s %255s %255s %255s %255s %i %255s %255s",
               &task->pid,	// processid
               dummy,		// processname
